...
* [LAB 1: Serverless Amazon CloudFront Log Analysis Pipeline](#lab-1-serverless-amazon-cloudfront-log-analysis-pipeline)
      * [Overview](#overview)
      ...
      * [Generate visualization using Amazon QuickSight](#generate-visualization-using-amazon-quicksight)
         ...
         * [(Optional)Generate visualization to status code by URI](#generate-visualization-to-status-code-by-uri)
         ...
         * [(Optional)Generate visualization to show device form factor ratio](#generate-visualization-to-show-device-form-factor-ratio)
         * [(Optional)Generate visualization to show device form factor ration by viewer country](#generate-visualization-to-show-device-form-factor-ration-by-viewer-country)
